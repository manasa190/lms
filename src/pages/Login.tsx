  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full gradient-secondary opacity-20 blur-3xl" />
      </div>
      ...
      >
        <div className="glass-card rounded-2xl p-8">
          ...
          <div className="mt-4 p-4 rounded-[1.5rem] bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/10 text-xs text-center">
            <p className="font-bold text-primary mb-1 uppercase tracking-widest text-[10px]">Universal Access</p>
            <p className="text-muted-foreground italic">"Enter any email and password to instantly access the platform as a new student."</p>
          </div>
        </div>
      </motion.div>
    </div>
